          ...
          {isMobile ? (
            ...
            <div className="slider_wrapper position-relative">
              ...
              <div className="slider_nav d-flex align-items-center justify-content-center nowrap">
                <button className="arrow-left arrow common_slider_arrow d-flex align-items-center justify-content-center">
                  <img src={LeftArrow} alt="arrow-img" />
                </button>
                <div className="swiper-custom-scrollbar slider_scrollbar"></div>
                <button className="arrow-right arrow common_slider_arrow d-flex align-items-center justify-content-center">
